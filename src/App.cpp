...
void App::loadGameObjects(){
	std::shared_ptr<VKE::Model> quadModel = VKE::Model::createModelFromFile(device, "D:\\dev\\Vulkan\\texture test\\resources\\models\\quad.obj");
	...
	coordinator.AddComponent(entity, ECS::Components::Model{quadModel});
